...
emp_name = st.text_input("Enter Employee Name:", "Uzma kanwal")
emp_id = st.text_input("Enter Employee ID:", "EMP004")

st.subheader("Assign to a Department ")
dept_name = st.text_input("Enter Department Name:", "Web Development")
