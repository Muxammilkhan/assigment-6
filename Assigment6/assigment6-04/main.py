...
user_name = st.text_input("Enter your name to open a bank account", placeholder="e.g. Ahmed, alina")
new_bank_name = st.text_input("Change bank name (optional)", placeholder="e.g. National Bank")
